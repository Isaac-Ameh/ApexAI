...
import { t as auth } from "./server-BeBv8MlV.mjs";
import { r as TriangleAlert } from "../_libs/lucide-react.mjs";
import { n as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CivmaWDa.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "max-w-md text-pretty text-sm break-words text-muted-foreground",
...
var styles_default = "/assets/styles-CT1etAQ3.css";
var APP_NAME = "ApexStudy";
...
var Route$5 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "ApexStudy turns a student's course materials into an adaptive study environment."
			},
			{
				name: "theme-color",
				content: "#0b0d10"
...
var $$splitComponentImporter$3 = () => import("./routes-0GE_gc6q.mjs");
var Route$4 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./login-1Cyohv34.mjs");
var Route$3 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("../_courseId-C-CeZwEw.mjs");
var Route$2 = createFileRoute("/courses/$courseId")({
	validateSearch: (search) => {
		const mode = search.mode;
		return {
			mode: mode === "practice" || mode === "exam" || mode === "listen" ? mode : "study",
			topic: typeof search.topic === "number" ? search.topic : Number(search.topic) || void 0
		};
	},
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./new-BtywDSPN.mjs");
var Route$1 = createFileRoute("/courses/new")({
	validateSearch: (search) => ({ sample: search.sample === 1 || search.sample === "1" ? 1 : void 0 }),
...
var rootRouteChildren = {
	...
	CoursesCourseIdRoute: Route$2.update({
		id: "/courses/$courseId",
		path: "/courses/$courseId",
		getParentRoute: () => Route$5
	}),
	CoursesNewRoute: Route$1.update({
		id: "/courses/new",
		path: "/courses/new",
		getParentRoute: () => Route$5
	}),
...
//#endregion
export { createSsrRpc as i, Route$1 as n, Route$2 as r, router_exports as t };
